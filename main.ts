...
namespace hicbit {
    ...
    */
    //% weight=98 blockGap=50 blockId=hicbit_setMotorSpeed1 block="Set motor1 speed|%speed1|and motor2|speed %speed2"
    //% speed1.min=-255 speed1.max=255
    //% speed2.min=-255 speed2.max=255
    export function hicbit_setMotorSpeed1(speed1: number, speed2: number) {
        let Turn: number = 0;//电机1：正 电机2：正
    ...
    */
    //% weight=97 blockGap=50 blockId=hicbit_setMotorSpeed2 block="Set motor3 speed|%speed1|and motor4|speed %speed2"
    //% speed1.min=-255 speed1.max=255
    //% speed2.min=-255 speed2.max=255
    export function hicbit_setMotorSpeed2(speed1: number, speed2: number) {
        let Turn: number = 0;//电机1：正 电机2：正
